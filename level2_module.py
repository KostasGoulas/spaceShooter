...
class GameAssets :
    def __init__(self, win_size):
        ...
        self.background  = self.loadImageAsset("night-sky-background\OEIRLL0.jpg")
...
class LevelEnemies:
    ...
    def fillLevelWithEnemy(self):
        ...
        dif = 50
        for i in range(4):
            self.createEnemy( self.enemy_assets[i+2] , (pos_ref[0] + i*160, dif + pos_ref[1]), EnemiesHealth(self.health_assets, 4)  )
            dif *= -1
